...
<div id="content-wrapper" class="d-flex flex-column">
	...
	<div id="content">
		...
		<div class="container-fluid">
			...
			<h1>갤러리 수정 페이지입니다.</h1>
			<form class="gallery" method="post" action="/gallery/modify">
			<input type="hidden" name="gno" value="${board.gno}" />
				<div class="form-group row">
					<div class="col-sm-12 ">
						<input type="text" value="${board.title}" class="form-control" id="exampleFirstName"
							placeholder="제목" name="title" required>
					</div>
					<div class="col-sm-12">
						<input type="text" value="${board.writer}" class="form-control" id="exampleLastName"
